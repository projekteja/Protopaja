...
class Player(Tk.Frame):
    ...
    def OnOpen(self):
        self.Media = self.Instance.media_new("C:/Users/Work/Downloads/video.mp4")
...
if __name__ == "__main__":
    ...
    player = Player(root, title="SAVOX PI")
    player2 = PlayerSide(root, title="SAVOX PI")
    player3 = PlayerSide(root, title="SAVOX PI")
